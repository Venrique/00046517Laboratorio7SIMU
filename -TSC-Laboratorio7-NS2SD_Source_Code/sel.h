...
Matrix createLocalK(int e,mesh &m){
    ...
    // [ B+K  E-L ]
    // [  G    0  ]
    Matrix matrixB,matrixK,matrixE,matrixL,matrixG;
    ...
    productRealMatrix(tau*J/(24*D),productMatrixMatrix(g_matrix,productMatrixMatrix(Alpha,Beta,2,2,6),6,2,6),matrixB);
    ...
    //Preparando matrixE (En clase conocida simplemente como G)
    ...
    //Preparando matrixL (En clase conocida simplemente como G)
    ...
    //Preparando matrixG (En clase conocida simplemente como D)
    ...
    ubicarSubMatriz(K,0,5,6,8,sumMatrix(matrixL,matrixE,6,3));
