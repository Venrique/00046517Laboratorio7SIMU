...
enum parameters {TAU,KA,DELTA,LAMBDA,EXTERNAL_FORCE_X,EXTERNAL_FORCE_Y, ETA};
...
class mesh{
    ...
    public:
        void setParameters(float tau,float k, float delta,float lambda, float psi_x, float psi_y, float eta){
            parameters[TAU]=tau;
            parameters[KA]=k;
            parameters[DELTA]=delta;
            parameters[LAMBDA]=lambda;
            parameters[EXTERNAL_FORCE_X]=psi_x;
            parameters[EXTERNAL_FORCE_Y]=psi_y;
            parameters[ETA]=eta;
        }
